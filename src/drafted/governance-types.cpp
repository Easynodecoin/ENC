...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EasynodecoinNetwork") type = EasynodecoinNetwork;
    if(strType == "EasynodecoinNetworkVariable") type = EasynodecoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EasynodecoinNetwork) s = "EasynodecoinNetwork";
    if(type == EasynodecoinNetworkVariable) s = "EasynodecoinNetworkVariable";
