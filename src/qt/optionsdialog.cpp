    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ENC-light"), QVariant("light"));
    //ui->theme->addItem(QString("ENC-light-hires"), QVariant("light-hires"));
    //ui->theme->addItem(QString("ENC-blue"), QVariant("drkblue"));
    //ui->theme->addItem(QString("ENC-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("ENC-traditional"), QVariant("trad"));
