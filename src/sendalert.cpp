...
2. run easynodecoind with -printalert or -sendalert like this:
   /path/to/easynodecoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://easynodecoin.io";
