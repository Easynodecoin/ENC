...
#define BOOST_TEST_MODULE Easynodecoin Test Suite

#include "test_easynodecoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_easynodecoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
