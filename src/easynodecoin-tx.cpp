...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Easynodecoin Core easynodecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  easynodecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded easynodecoin transaction") + "\n" +
              "  easynodecoin-tx [options] -create [commands]   " + _("Create hex-encoded easynodecoin transaction") + "\n" +
              "\n";
