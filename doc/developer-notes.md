...
Easynodecoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 17111.
...
However, in open source software such as Easynodecoin Core, where everyone uses
...
pay attention to for reviewers of Easynodecoin Core code.

General Easynodecoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Easynodecoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
