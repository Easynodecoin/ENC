...
#Set env vars
buildDir = BUILDDIR
if "ENCCOIND" not in os.environ:
    os.environ["ENCCOIND"] = buildDir + '/src/easynodecoind' + EXEEXT
if "ENCCOINCLI" not in os.environ:
    os.environ["ENCCOINCLI"] = buildDir + '/src/easynodecoin-cli' + EXEEXT
...
#    'rpcbind_test.py', #temporary, bug in libevent, see #6655
    ...
    'mempool_packages.py',
    'maxuploadtarget.py',
    # 'replace-by-fee.py', # RBF is disabled in Easynodecoin Core
]
